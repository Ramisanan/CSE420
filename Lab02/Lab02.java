...
public class Lab02{
   public static void main(String[] args) throws FileNotFoundException {
    ...
    while(af.hasNext()&& k<=n){
      ...
      if(web(s)&& email(s)){
        System.out.print(" Web and email address found in line "+count);
      }
      else if(web(s)){
        System.out.print(" Web address found in line "+count);
      }
      else if(email(s)){
        System.out.print(" Email address found in line "+count);
      }
      else if(web(s)==false && email(s)==false){
        System.out.print(" Nothing found in line "+count);
      }
      count++;
      System.out.println();
    }    
